...
public class Especie {
   ...
   String cuidadorEspecie="";
    ...
    public Especie(String nombre, String nombreCientifico, String descripcion, String Cuidador) {
       ...
       public String getEspecie(EspecieDTO Especie){
        return "ID: " + Especie.getId() + ", Nombre: " + Especie.getNombre() + ", Nombre cientifico: " + Especie.getNombreCientifico()+", Descripcion"+Especie.getDescripcion();
    }
