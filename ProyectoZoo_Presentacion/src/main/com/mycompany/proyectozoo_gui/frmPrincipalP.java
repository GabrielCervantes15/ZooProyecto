...
ILogica logica;
    ...
    private void initComponents() {
        ...
        jButton1.setText("RegistrarDatos(Base de datos)");
        ...
        jButton2.setText("RegistrarDatos(Base de datos externa)");
    ...
    private void btnQuejaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuejaActionPerformed
     if (logica.recuperaItinerarios().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No se pudo recuperar los datos Correctamente\nPara esta Opcion Ocupas:\n-Registrar Itinerario", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
             this.dispose();
  ...
  if (logica.recuperaDatosHabitat()==null) {
            ...
            JOptionPane.showMessageDialog(this, "Datos Registrados Exitosamente", "Informacion", JOptionPane.INFORMATION_MESSAGE);
        }else{
 ...
 logica.RegistrarDatosExternos();        // TODO add your handling code here:
