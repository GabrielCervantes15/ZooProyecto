...
import Controles.ControlDescripcion;
...
public class FachadaLogica implements ILogica {
    ...
    private ControlDescripcion controldescripcion;
    ...
    public FachadaLogica() {
        ...
        this.controldescripcion = new ControlDescripcion();
    }
...
//       frm.setVisible(true);
    ...
    public Itinerario verificaNombreItinerario(String nombre) {
       ...
       @Override
    public Descripcion verificaNombreDescripcion(String nombre) {
        return controldescripcion.verificaDescripcion(nombre);
    }
